              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-6 lg:mb-8">
                <div className="glass-card">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="min-w-0">
                      <h3 className="text-xl sm:text-2xl font-bold text-dark-primary transition-colors duration-300 hover:text-blue-400">89%</h3>
                ...
                <div className="glass-card">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="min-w-0">
                      <h3 className="text-xl sm:text-2xl font-bold text-dark-primary transition-colors duration-300 hover:text-green-400">2.1h</h3>
                ...
                <div className="glass-card">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="min-w-0">
                      <h3 className="text-xl sm:text-2xl font-bold text-dark-primary transition-colors duration-300 hover:text-orange-400">12</h3>
                ...
                <div className="glass-card">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="min-w-0">
                      <h3 className="text-xl sm:text-2xl font-bold text-dark-primary transition-colors duration-300 hover:text-purple-400">156</h3>
    ...
    <div className="flex h-screen bg-dark-bg overflow-hidden" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      `}>
        ...
        <div className="p-3 sm:p-4 lg:p-6 border-t border-dark-color space-y-3 sm:space-y-4 flex-shrink-0">
          {/* System Status */}
          <div className="glass-card p-3 lg:p-4 text-center hover:border-cyan-400/50 transition-all duration-300">
          ...
          <div className="glass-card p-3 hover:border-cyan-400/50 transition-all duration-300">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 lg:w-10 lg:h-10 bg-gradient-to-br from-orange-600 to-red-600 rounded-full flex items-center justify-center flex-shrink-0">
                <UserCheck className="w-4 h-4 lg:w-5 lg:h-5 text-white" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-xs sm:text-sm font-medium text-dark-primary truncate hover:text-cyan-400 transition-colors duration-300">
                  {user?.name || 'Gestor'}
                </p>
