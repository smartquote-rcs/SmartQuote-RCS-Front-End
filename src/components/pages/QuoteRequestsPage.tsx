        ...
        <div className="flex flex-col space-y-3 min-w-0 lg:min-w-[140px]">
          ...
          <div className="flex flex-row lg:flex-col space-x-2 lg:space-x-0 lg:space-y-2">
            ...
            {cotacao.status === 'pending_approval' && (
              <>
                <button className="bg-green-600/20 hover:bg-green-600/40 border border-green-500/30 text-green-400 px-3 py-2 text-xs rounded-lg transition-all duration-200 flex items-center justify-center space-x-1 font-medium flex-1 lg:flex-none">
                  <CheckCircle className="w-3 h-3" />
                  <span>Aprovar</span>
                </button>
                <button className="bg-red-600/20 hover:bg-red-600/40 border border-red-500/30 text-red-400 px-3 py-2 text-xs rounded-lg transition-all duration-200 flex items-center justify-center space-x-1 font-medium flex-1 lg:flex-none">
