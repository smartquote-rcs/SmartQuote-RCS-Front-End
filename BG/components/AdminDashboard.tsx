...
const mainNavItems = [
  { icon: BarChart3, label: "Painel Administrativo", key: "dashboard", active: true },
          ...
          <div className="flex flex-col h-full">
            <header className="bg-dark-bg border-b border-dark-color px-4 lg:px-8 py-4 lg:py-6 flex-shrink-0">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-3 sm:space-y-0">
                <div>
                  <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-dark-primary">Gestão de Dados</h1>
                  <p className="text-xs sm:text-sm text-dark-secondary mt-1">Administração avançada de dados do sistema</p>
                </div>
              </div>
            </header>
            ...
            <main className="flex-1 overflow-auto p-4 lg:p-8 bg-dark-bg">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-6 lg:mb-8">
                <div className="dark-card p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="min-w-0">
                      <h3 className="text-xl sm:text-2xl font-bold text-dark-primary">2.4GB</h3>
                      <p className="text-xs sm:text-sm text-dark-secondary truncate">Dados Armazenados</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="dark-card p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="min-w-0">
                      <h3 className="text-xl sm:text-2xl font-bold text-dark-primary">99.9%</h3>
                      <p className="text-xs sm:text-sm text-dark-secondary truncate">Uptime</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="dark-card p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="min-w-0">
                      <h3 className="text-xl sm:text-2xl font-bold text-dark-primary">15,247</h3>
                      <p className="text-xs sm:text-sm text-dark-secondary truncate">Registros Totais</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="dark-card p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="min-w-0">
                      <h3 className="text-xl sm:text-2xl font-bold text-dark-primary">Diário</h3>
                      <p className="text-xs sm:text-sm text-dark-secondary truncate">Backup</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center py-8 lg:py-12">
                ...
                <h3 className="text-base sm:text-lg font-medium text-dark-primary mb-2">Gestão Avançada de Dados</h3>
                <p className="text-sm sm:text-base text-dark-secondary px-4">Ferramentas de administração e backup em desenvolvimento</p>
              </div>
            </main>
          </div>
        );
      ...
      `}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 sm:space-x-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-dark-secondary font-medium truncate">Painel Administrativo</p>
              </div>
            </div>
            <button
              onClick={() => setIsMobileMenuOpen(false)}
        ...
        <div className="p-3 sm:p-4 lg:p-6 border-t border-dark-color space-y-3 sm:space-y-4 flex-shrink-0">
          ...
          <div className="bg-dark-card rounded-xl p-3 lg:p-4 text-center border border-dark-color">
            ...
            <p className="text-xs text-dark-secondary mb-3">IA: Online | Admin: Ativo</p>
