    ...
    <div className="min-h-screen bg-gradient-to-br from-black-900 via-black-900 to-blck-900 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            <motion.div
              className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-cyan-400 via-blue-500 to-indigo-600 rounded-2xl sm:rounded-3xl lg:rounded-4xl flex items-center justify-center shadow-2xl relative overflow-hidden"
              whileHover={{
                rotate: [0, 10, -10, 0],
                scale: 1.15,
            ...
            >
              ...
              />
              <motion.span
                className="text-white font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl relative z-10"
                animate={{
                  scale: [1, 1.2, 1],
                  textShadow: [
